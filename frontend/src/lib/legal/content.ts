...
// These notices describe the review feature and its security processing.
privacyPolicy.en.sections.push({ title: "Reviews and abuse prevention", text: "When you publish a review, your profile first name, review text, product rating and publication date are public. Helpfulness vote totals are also public. Your email is not included in public reviews; only the authorised review moderator can access the author's email in the administration area. Reviews and votes are linked to your account to enforce one review per product and one vote per review. Moderation actions are recorded. Cloudflare Turnstile runs when you submit a review or registration form and processes technical device and network information to prevent automated abuse. This security check is separate from optional Google Analytics." })
privacyPolicy.sr.sections.push({ title: "Recenzije i sprečavanje zloupotrebe", text: "Kada objavite recenziju, javni su ime iz profila, tekst, ocena proizvoda i datum objave, kao i zbir glasova o korisnosti. E-pošta nije deo javne recenzije; samo ovlašćeni moderator recenzija može videti e-poštu autora u administraciji. Recenzije i glasovi povezani su sa nalogom radi ograničenja na jednu recenziju po proizvodu i jedan glas po recenziji. Radnje moderacije se beleže. Cloudflare Turnstile pokreće se pri slanju recenzije ili obrasca registracije i obrađuje tehničke podatke uređaja i mreže radi sprečavanja automatizovane zloupotrebe. Ova bezbednosna provera je odvojena od opcione Google analitike." })
cookiePolicy.en.sections.push({ title: "Form security", text: "Cloudflare Turnstile is loaded only when you request to submit a registration or review. It is used for abuse prevention, not audience measurement. Rejecting analytics does not bypass this security check. Helpfulness votes require sign-in; no anonymous voting cookie is used. Cloudflare privacy information: https://www.cloudflare.com/privacypolicy/" })
cookiePolicy.sr.sections.push({ title: "Bezbednost obrazaca", text: "Cloudflare Turnstile se učitava tek kada zatražite slanje registracije ili recenzije. Koristi se za sprečavanje zloupotrebe, ne za analitiku posete. Odbijanje analitike ne isključuje ovu bezbednosnu proveru. Glasanje o korisnosti zahteva prijavu; ne koristi se kolačić za anonimno glasanje. Informacije o privatnosti Cloudflare-a: https://www.cloudflare.com/privacypolicy/" })
